...
- `control-plane-dashboard-homepage.md`: current homepage information architecture, top-summary versus drilldown rules, reviewer/operator split, and demo-versus-live guidance.
