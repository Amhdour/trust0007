...
def test_dashboard_reaches_go_for_healthy_live_configuration(monkeypatch) -> None:
    ...
    monkeypatch.setattr(posture_service_module, "load_latest_identity_evidence", lambda root: {"live": True, "authenticated": True, "captured_at": "2026-04-19T10:00:00+00:00"})
    monkeypatch.setattr(posture_service_module, "load_latest_policy_evidence", lambda root: {"allow": True, "engine": "opa", "engine_reachable": True, "captured_at": "2026-04-19T10:00:00+00:00"})
    monkeypatch.setattr(posture_service_module, "load_latest_retrieval_evidence", lambda root: {"allow": True, "live_backend": True, "backend_verified": True, "captured_at": "2026-04-19T10:00:00+00:00"})
    monkeypatch.setattr(posture_service_module, "load_latest_secret_evidence", lambda root: {"required": True, "fetched": True, "captured_at": "2026-04-19T10:00:00+00:00"})
