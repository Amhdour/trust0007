...
def test_strict_live_dify_handoff_passes_with_runtime_specific_governance(live_stack: LiveStackHarness) -> None:
    token = live_stack.mint_access_token()
...
def test_strict_live_dify_handoff_denies_unapproved_mcp_server(live_stack: LiveStackHarness) -> None:
    token = live_stack.mint_access_token()
