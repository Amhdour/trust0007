...
from .test_strict_live_shared import cards, live_stack, section


def test_strict_live_onyx_handoff_passes_through_real_stack(live_stack) -> None:
...
def test_strict_live_onyx_handoff_fails_closed_when_keycloak_is_unavailable(live_stack) -> None:
    token = live_stack.mint_access_token()
...
def test_strict_live_onyx_handoff_fails_closed_when_opa_is_unavailable(live_stack) -> None:
    token = live_stack.mint_access_token()
...
def test_strict_live_onyx_handoff_fails_closed_when_qdrant_is_unavailable(live_stack) -> None:
    token = live_stack.mint_access_token()
...
def test_strict_live_onyx_handoff_fails_closed_when_vault_is_unavailable(live_stack) -> None:
    token = live_stack.mint_access_token()
